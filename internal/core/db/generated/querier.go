...
type Querier interface {
	...
	GetAllNotesKeywords(ctx context.Context) ([]GetAllNotesKeywordsRow, error)
	...
	GetNoteKeywords(ctx context.Context, filename string) (sql.NullString, error)
	...
	SetNoteKeywords(ctx context.Context, arg SetNoteKeywordsParams) error

...
func ProcessPDF(path, filename string, modTime time.Time) ([]Document, []string, []string) {
	...
	// Extrai keywords (top 15 termos mais frequentes)
...
// stopwords contem as listas completas de stopwords do NLTK (pt + en)
// Fonte: https://github.com/nltk/nltk/blob/develop/nltk/corpus/stopwords.py
var stopwords = map[string]bool{
	// ── Portugues (NLTK: 131 palavras) ──
	"a": true, "ao": true, "aos": true,
	...
	"eu": true,
	"foi": true, "fomos": true, "for": true, "fossem": true, "fui": true,
	"ha": true,
	"isso": true, "isto": true,
	"ja": true,
	"lhe": true, "lhes": true,
	"mais": true, "mas": true, "me": true,
	"mesma": true, "mesmas": true, "mesmo": true, "mesmos": true,
	"meu": true, "meus": true, "minha": true, "minhas": true,
	"muito": true,
	"na": true, "nas": true, "nem": true, "no": true, "nos": true, "nós": true,
	"num": true, "numa": true,
	...
	"to": true, "tu": true, "tua": true, "tuas": true,
	...
	"o": true, "re": true, "ve": true, "y": true, "ma": true,
}
